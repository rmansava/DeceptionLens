"""Sweep k values on chunk 184 for the dino image. Shows page 210 rank and votes."""
import sys, os
...
print(f"{'k':>6} | {'Search':>7} | {'Votes':>7} | {'Total':>7} | {'Page210':>8} | {'Rank':>5} | {'#1 Result':>50}")
print("-" * 110)

for k in [5, 20, 50, 100, 250, 500, 1000]:
    t0 = time.time()
    ...
    print(f"{k:>6} | {search_time:>5.1f}s | {vote_time:>5.1f}s | {total_matches:>7,} | {page210_votes:>8} | {page210_rank:>5} | {top_short:>50}")
